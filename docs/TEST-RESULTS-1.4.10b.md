...
Nachtrag zentrale Messwertprüfung 25.09.2026: Hauswerte werden ausschließlich im Regelzyklus veröffentlicht; moduleigene Berechnungsereignisse werden deaktiviert. Sechs neue Tests prüfen verzögerte Hauswerte ohne Verfälschung der Anzeige/Glättung, unterschiedliche Quellaktualisierungen statt wiederholter Abfragen, Wartezeitablauf, Vorrang von Netzlimit/0-%-Anteil/Ziel-SoC, gezielte Ereignisdeaktivierung und Phasenbestätigung ohne vorzeitige Wiederfreigabe. 79 Ladeverhaltenstests plus 3 Basisregressionen = 82 bestanden. Syntax-/Metadatenprüfung bestanden. Tatsächlicher Quell-Messzeitpunkt und Verzögerung des Nutzersystems sind weiterhin nicht bekannt; Hardwareprüfung der festen Beta-Plausibilitätsgrenzen erforderlich.
